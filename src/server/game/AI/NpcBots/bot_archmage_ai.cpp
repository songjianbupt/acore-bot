...
*/
        ...
        void ApplyClassDamageMultiplierSpell(int32& damage, SpellNonMeleeDamage& /*damageinfo*/, SpellInfo const* spellInfo, WeaponAttackType /*attackType*/, bool iscrit) const override
        {
            ...
            if (baseId == MAIN_ATTACK_1 || baseId == BLIZZARD_1)
                fdamage += me->SpellBaseDamageBonusDone(SPELL_SCHOOL_MASK_MAGIC) * (spellInfo->Effects[0].BonusMultiplier - 1.f) * me->GetVictim()->CalculateDefaultCoefficient(spellInfo, SPELL_DIRECT_DAMAGE) * me->GetVictim()->CalculateLevelPenalty(spellInfo);
        ...
        void SpellHitTarget(WorldObject* wtarget, SpellInfo const* spell)
        {
        ...
        void SpellHit(WorldObject* wcaster, SpellInfo const* spell)
        {
        ...
        void OnBotEnterVehicle(Vehicle * vehicle)
        {
            me->Dismount();
