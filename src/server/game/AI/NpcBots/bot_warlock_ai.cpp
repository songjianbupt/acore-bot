    ...
    struct warlock_botAI : public bot_ai
    {
        ...
        void ApplyClassDamageMultiplierSpell(int32& damage, SpellNonMeleeDamage& damageinfo, SpellInfo const* spellInfo, WeaponAttackType /*attackType*/, bool iscrit) const override
        {
            ...
            if (lvl >= 25 && baseId == CORRUPTION_1)
                fdamage += me->SpellBaseDamageBonusDone(SPELL_SCHOOL_MASK_MAGIC) * 0.36f * me->GetVictim()->CalculateDefaultCoefficient(spellInfo, DOT) * me->GetVictim()->CalculateLevelPenalty(spellInfo);
            ...
            if ((_spec == BOT_SPEC_WARLOCK_AFFLICTION) &&
                ...
                fdamage += me->SpellBaseDamageBonusDone(SPELL_SCHOOL_MASK_MAGIC) * 0.05f * me->GetVictim()->CalculateDefaultCoefficient(spellInfo, DOT) * me->GetVictim()->CalculateLevelPenalty(spellInfo);
        ...
        void SummonBotPet()
        {
            ...
            me->GetNearPoint(myPet, pos.m_positionX, pos.m_positionY, pos.m_positionZ, myPet->GetObjectSize(), 0, me->GetOrientation() + M_PI / 2);
